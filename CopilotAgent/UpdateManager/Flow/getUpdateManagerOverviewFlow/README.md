<h3>Azure UpdateManager Copilot Studio Flow - getUpdateManagerOverview</h3>
 


Click on "+" and create "Initialize Variable":

<img src="./images/Initializevariable-querygraph.jpg" alt="querygraphvariable" width="800" >

Set properties end past the following query:

<img src="./images/querygraph.jpg" alt="querygraphvariable" width="800" >
...
<img src="./images/set-variable.jpg" alt="setvariable" width="800" >

Create another "HTTP Request" for OpenAI service:

<img src="./images/http_openAIrequest.jpg" alt="HTTPrequestOpenAIe" width="800" >
...
<img src="./images/parseJsonOpneAI.jpg" alt="parseJSON" width="800" >
...
<img src="./images/initialize-respond.jpg" alt="AUMOverview" width="800" >

Now create an "Apply To Each" block, and ensure that the variable follow the images below:

<img src="./images/applytoEach.jpg" alt="Applytoeach" width="800" >

<img src="./images/applytoEachvariable.jpg" alt="Applytoeachvariable" width="800" >

Finally we can parse the output to Copilot Agent:

<img src="./images/respondtoagent.jpg" alt="respond" width="800" >
